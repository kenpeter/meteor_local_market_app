// It capitalize the mongo object, no var. Lower case in the acutal Mongo
...
Meteor.startup(function() {
  // Activities.find() is like sql's result, you still need fetch() to get actual thing
