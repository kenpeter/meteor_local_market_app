...
Template.recipe.onCreated(function() {
  /*
    Router.current().params === [name: "summer-apricots-honey-panna-cotta", hash: undefined, activityId: "d8mWzBjBKAzpNcKE9"]
  */
